...
data modify entity @s[nbt={VillagerData:{profession:"minecraft:butcher"}}] Offers.Recipes[{sell:{id:"minecraft:rabbit_stew"}}].sell merge value {id:"minecraft:suspicious_stew",Count:1b,tag:{display:{"Name":"{\"translate\":\"item.cpp.rabbit_stew\"}",Lore:["{\"translate\":\"lore.cpp.strength\"}"]},id:"cpp:rabbit_stew",CustomModelData:12970008,Effects:[{EffectDuration:600,EffectId:5b},{EffectDuration:10,EffectId:23b}]}}
