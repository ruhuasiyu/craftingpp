...
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:compressor"}}]}] run function cpp:use_carrot_on_a_stick/tool/compressor/check
...
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:golem_miner"}}]}] anchored eyes run function cpp:use_carrot_on_a_stick/golem/miner
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:golem_farmer"}}]}] anchored eyes run function cpp:use_carrot_on_a_stick/golem/farmer
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:golem_fisher"}}]}] anchored eyes run function cpp:use_carrot_on_a_stick/golem/fisher
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:golem_warrior"}}]}] anchored eyes run function cpp:use_carrot_on_a_stick/golem/warrior
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:golem_herder"}}]}] anchored eyes run function cpp:use_carrot_on_a_stick/golem/herder
