...
execute at @e[type=item,distance=..6,nbt={Age:0s},sort=nearest,limit=1] align xyz run function cpp:chain/pickaxe2/mark
execute at @e[type=item,distance=..6,nbt={Age:1s},sort=nearest,limit=1] align xyz run function cpp:chain/pickaxe2/mark
