...
execute as @s[scores={cppMacType=3}] run loot insert ~ ~ ~ loot blocks/coal_ore
execute as @s[scores={cppMacType=4}] run loot insert ~ ~ ~ loot blocks/diamond_ore
execute as @s[scores={cppMacType=5}] run loot insert ~ ~ ~ loot blocks/emerald_ore
execute as @s[scores={cppMacType=6}] run loot insert ~ ~ ~ loot blocks/nether_quartz_ore
