...
scoreboard players add @s[scores={cppMacType=41..53,cppStoredxp=32..}] cppTick 6
...
execute as @s[scores={cppMacType=41..53,cppStoredxp=32..}] if score @s cppTick >= #mob_projector_cd cppValue run function cpp:mob_projector/done3
