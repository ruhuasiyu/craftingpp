...
execute as @s[nbt={Item:{id:"minecraft:acacia_sapling"}}] if score #craftingpp cppValue matches 1 align xyz positioned ~0.5 ~ ~0.5 run function cpp:dispenser_plant/plant_cpp
