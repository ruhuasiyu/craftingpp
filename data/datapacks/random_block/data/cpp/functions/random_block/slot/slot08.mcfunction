data modify entity @e[type=item,tag=cpp_random_block,limit=1,sort=nearest,distance=..2] Item.id set from entity @s Inventory[{Slot:-106b}].tag.BlockEntityTag.Items[8].id
