...
summon armor_stand ~ ~ ~ {Invulnerable:1b,Invisible:1b,Small:1b,Marker:1b,NoGravity:1b,DisabledSlots:7967,Tags:["cpp_machine","cpp_crafting_machine","cpp_barrel","cpp_need_fire"],Rotation:[0.0f,0.0f],Fire:32767s}
