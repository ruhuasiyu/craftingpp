...
execute if score #temp cppValue matches 12970111..12970126 store result block ~ 255 ~ Items[0].tag.CustomModelData int 1 run scoreboard players add #temp cppValue 100
