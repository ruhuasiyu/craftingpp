...
execute if block ~ ~ ~ barrel{Items:[{tag:{dict:"salt"}},{id:"minecraft:pumpkin"},{id:"minecraft:bowl"},{id:"minecraft:carrot"},{id:"minecraft:potato"}]} run loot replace block ~ ~ ~ container.16 loot cpp:raw_colorful_vegetable
...
execute if block ~ ~ ~ barrel{Items:[{tag:{dict:"salt"}},{id:"minecraft:porkchop"},{id:"minecraft:bowl"},{id:"minecraft:carrot"},{id:"minecraft:potato"}]} run loot replace block ~ ~ ~ container.16 loot cpp:raw_braised_pork_with_potatoes
...
execute if block ~ ~ ~ barrel{Items:[{tag:{dict:"salt"}},{id:"minecraft:beef"},{id:"minecraft:bowl"},{id:"minecraft:carrot"},{id:"minecraft:potato"}]} run loot replace block ~ ~ ~ container.16 loot cpp:raw_braised_beef_with_potatoes
...
execute if block ~ ~ ~ barrel{Items:[{tag:{dict:"salt"}},{id:"minecraft:rabbit"},{id:"minecraft:bowl"},{id:"minecraft:carrot"},{id:"minecraft:potato"}]} run loot replace block ~ ~ ~ container.16 loot cpp:raw_rabbit_stew
...
execute if block ~ ~ ~ barrel{Items:[{tag:{dict:"salt"}},{id:"minecraft:cooked_cod"},{id:"minecraft:baked_potato"},{tag:{id:"cpp:ketchup"}},{id:"minecraft:bowl"}]} run loot replace block ~ ~ ~ container.16 loot cpp:fish_and_chips
