...
execute store result entity @s[gamemode=!creative] Inventory[{Slot:-106b}].tag.BlockEntityTag.Items[8].Count byte 1 run scoreboard players remove #temp cppRandom 1
