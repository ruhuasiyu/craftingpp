scoreboard players operation @p[tag=cpp_new_player] cppSpawnX = #skyislandDistance cppValue
...
scoreboard players operation @p[tag=cpp_new_player] cppSpawnZ = #skyislandDistance cppValue
