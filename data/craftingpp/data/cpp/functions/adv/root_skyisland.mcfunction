...
summon minecraft:area_effect_cloud ~ ~ ~ {Invulnerable:1b,NoGravity:1b,Tags:["cpp_temp"]}
execute as @e[type=minecraft:area_effect_cloud,tag=cpp_temp,distance=..1,limit=1] run function cpp:adv/root_skyisland1
