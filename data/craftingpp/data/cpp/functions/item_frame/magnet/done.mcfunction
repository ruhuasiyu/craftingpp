tag @e[type=item,distance=..0.5,limit=1] add cpp_item_frame_magnet_item
data modify storage cpp:dist Item set from entity @e[type=item,distance=..0.5,limit=1,tag=cpp_item_frame_magnet_item]
...
execute as @s[tag=cpp_dist_success] run kill @e[type=item,distance=..0.5,limit=1,tag=cpp_item_frame_magnet_item]
