...
execute as @s[scores={cppTradeMode=2,cppTradeValue=2880..}] run function cpp:trade_machine/mode2
execute as @s[scores={cppTradeMode=3,cppTradeValue=720..}] run function cpp:trade_machine/mode3
