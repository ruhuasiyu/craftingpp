...
execute if score $skyislandMode cppConfig matches 1 as @e[type=armor_stand,distance=..9,tag=cpp_loc_block_pos] at @s align xyz run function cpp:blocks/grass/done
