...
# 玩家位置是否是特定方块
execute as @e[type=armor_stand,distance=..9,tag=cpp_loc_block_as,tag=cpp_temp] at @s align xyz positioned ~0.5 ~ ~0.5 unless entity @e[type=armor_stand,distance=..0.1,tag=cpp_block] run function cpp:misc/loc/check
# 若未找到，循环
