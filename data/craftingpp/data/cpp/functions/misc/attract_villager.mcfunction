tp @s ~ ~ ~ facing entity @p[predicate=cpp:hand_emerald_block]
...
execute store result score #temp0 cppValue run data get entity @p[predicate=cpp:hand_emerald_block] Pos[0] 100
...
execute store result score #temp0 cppValue run data get entity @p[predicate=cpp:hand_emerald_block] Pos[2] 100
