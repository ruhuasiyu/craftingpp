# 获取随机位置
data modify storage cpp:temp random_block set from entity @s Inventory[{Slot:-106b}].tag
execute store result score #random_max cppValue run data get storage cpp:temp random_block.BlockEntityTag.Items
...
data modify block ~ 255 ~ Items append from storage cpp:temp random_block.BlockEntityTag.Items[0]
...
# 副手
execute store result storage cpp:temp random_block.BlockEntityTag.Items[0].Count byte 0.99999 run data get storage cpp:temp random_block.BlockEntityTag.Items[0].Count
data remove storage cpp:temp random_block.BlockEntityTag.Items[{Count:0b}]
data modify block ~ 255 ~ Items set value [{Slot:0b,id:"minecraft:shulker_box",Count:1b}]
data modify block ~ 255 ~ Items[0].tag set from storage cpp:temp random_block
