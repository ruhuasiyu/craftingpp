...
execute store result score #temp0 cppValue run data get entity @p[predicate=cpp:has_magnet] Pos[0] 100
...
execute store result score #temp0 cppValue run data get entity @p[predicate=cpp:has_magnet] Pos[1] 100
...
execute store result score #temp0 cppValue run data get entity @p[predicate=cpp:has_magnet] Pos[2] 100
