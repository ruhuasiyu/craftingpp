execute if block ~ ~ ~ barrel{Items:[{Slot:3b,id:"minecraft:potion",tag:{Potion:"minecraft:water"}},{Slot:4b,tag:{id:"cpp:ammonia_refrigerant"}}]} run scoreboard players set @s cppMacType 1
