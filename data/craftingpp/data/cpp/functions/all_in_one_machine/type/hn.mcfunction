execute if block ~ ~ ~ barrel{Items:[{Slot:4b,tag:{id:"cpp:iron_dust"}},{Slot:3b,id:"minecraft:sand"}]} run scoreboard players set @s cppMacType 1
...
execute if block ~ ~ ~ barrel{Items:[{Slot:3b,tag:{id:"cpp:silicon_dust"}},{Slot:4b,id:"minecraft:sand"}]} run scoreboard players set @s cppMacType 7
execute if block ~ ~ ~ barrel{Items:[{Slot:3b,tag:{id:"cpp:silicon_dust"}},{Slot:4b,id:"minecraft:red_sand"}]} run scoreboard players set @s cppMacType 7

execute if block ~ ~ ~ barrel{Items:[{Slot:4b,tag:{id:"cpp:rare_earth_dust"}},{Slot:3b,id:"minecraft:sand"}]} run scoreboard players set @s cppMacType 8
execute if block ~ ~ ~ barrel{Items:[{Slot:4b,tag:{id:"cpp:rare_earth_dust"}},{Slot:3b,id:"minecraft:red_sand"}]} run scoreboard players set @s cppMacType 8
execute if block ~ ~ ~ barrel{Items:[{Slot:3b,tag:{id:"cpp:rare_earth_dust"}},{Slot:4b,id:"minecraft:sand"}]} run scoreboard players set @s cppMacType 8
execute if block ~ ~ ~ barrel{Items:[{Slot:3b,tag:{id:"cpp:rare_earth_dust"}},{Slot:4b,id:"minecraft:red_sand"}]} run scoreboard players set @s cppMacType 8

execute if block ~ ~ ~ barrel{Items:[{Slot:4b,tag:{id:"cpp:steel_dust"}},{Slot:3b,id:"minecraft:sand"}]} run scoreboard players set @s cppMacType 9
...
execute if block ~ ~ ~ barrel{Items:[{Slot:3b,id:"minecraft:glass_bottle"},{Slot:4b,id:"minecraft:sand"}]} run scoreboard players set @s cppMacType 10
execute if block ~ ~ ~ barrel{Items:[{Slot:3b,id:"minecraft:glass_bottle"},{Slot:4b,id:"minecraft:red_sand"}]} run scoreboard players set @s cppMacType 10

scoreboard players add @s[scores={cppMacType=1..6,cppStoredxp=1..}] cppTick 24
scoreboard players add @s[scores={cppMacType=7..10,cppStoredxp=4..}] cppTick 6
execute as @s[scores={cppMacType=1..6,cppStoredxp=1..}] if score @s cppTick >= #all_in_one_machine_cd cppValue run function cpp:all_in_one_machine/done
execute as @s[scores={cppMacType=7..10,cppStoredxp=4..}] if score @s cppTick >= #all_in_one_machine_cd cppValue run function cpp:all_in_one_machine/done
