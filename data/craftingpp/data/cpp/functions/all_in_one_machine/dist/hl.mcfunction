...
execute as @s[scores={cppMacType=2}] run loot replace block ~ ~ ~ container.21 2 loot cpp:
execute as @s[scores={cppMacType=3}] run loot replace block ~ ~ ~ container.21 2 loot cpp:
...
execute as @s[scores={cppMacType=6}] run loot replace block ~ ~ ~ container.21 2 loot cpp:
execute as @s[scores={cppMacType=7}] run loot replace block ~ ~ ~ container.21 2 loot cpp:
