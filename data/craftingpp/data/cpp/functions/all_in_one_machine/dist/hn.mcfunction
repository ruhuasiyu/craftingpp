...
execute as @s[scores={cppMacType=9}] run loot replace block ~ ~ ~ container.21 2 loot cpp:
execute as @s[scores={cppMacType=10}] run loot replace block ~ ~ ~ container.21 2 loot cpp:
