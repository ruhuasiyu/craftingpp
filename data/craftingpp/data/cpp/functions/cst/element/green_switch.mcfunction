...
execute store result score #t cppValue run data get storage cpp:temp green.Item.tag.cppLiquid.type
execute if score #t cppValue matches 0 run data modify storage cpp:temp green.Item.tag.cppLiquid.type set value 1
...
execute if score #t cppValue matches 1 run data modify storage cpp:temp green.Item.tag.cppLiquid.type set value 0
