...
execute as @s[predicate=cpp:mainhand/green_force_of_water] at @s anchored eyes run function cpp:cst/element/green
...
execute as @s[predicate=cpp:mainhand/infinite_bucket] unless score @s cppSneakTime matches 1 at @s anchored eyes run function cpp:tool/infinite_bucket
