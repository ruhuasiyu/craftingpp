...
# 配方
execute if block ~ ~ ~ barrel{Items:[{Slot:9b},{Slot:11b},{Slot:13b,id:"minecraft:experience_bottle",Count:64b},{Slot:16b,tag:{cppClear:1b}}]} run function cpp:golden_anvil/type
