...
data modify storage cpp:playerbag Items[{id:'minecraft:netherite_sword',tag:{display:{Name:'{"text":"凤凰剑"}'}}}].tag.CustomModelData set value 12970004
data modify storage cpp:playerbag Items[{id:'minecraft:netherite_sword',tag:{display:{Name:'{"text":"凤凰剑"}'}}}].tag.display.Name set value '{"text":"凤凰剑","italic":"false"}'
