...
data modify storage cpp:playerbag Items[{id:'minecraft:netherite_sword',tag:{display:{Name:'{"text":"尚方斩马剑"}'}}}].tag.CustomModelData set value 12970003
data modify storage cpp:playerbag Items[{id:'minecraft:netherite_sword',tag:{display:{Name:'{"text":"尚方斩马剑"}'}}}].tag.display.Name set value '{"text":"尚方斩马剑","italic":"false"}'
