...
data modify storage cpp:playerbag Items[{id:'minecraft:netherite_sword',tag:{display:{Name:'{"text":"霜之哀伤"}'}}}].tag.CustomModelData set value 12970001
data modify storage cpp:playerbag Items[{id:'minecraft:netherite_sword',tag:{display:{Name:'{"text":"霜之哀伤"}'}}}].tag.display.Name set value '{"text":"霜之哀伤","italic":"false"}'
