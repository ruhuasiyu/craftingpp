...
data remove block ~ 255 ~ Items[0].tag.BlockEntityTag.Patterns[-1]
execute unless data block ~ 255 ~ Items[0].tag.BlockEntityTag.Patterns[] run data remove block ~ 255 ~ Items[0].tag.BlockEntityTag.Patterns
