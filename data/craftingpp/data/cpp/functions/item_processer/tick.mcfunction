...
execute as @s[tag=!cpp_redstone_powered] if block ~ ~ ~ barrel{Items:[{Slot:3b},{Slot:12b},{Slot:15b,tag:{cppClear:1b}},{Slot:16b,tag:{cppClear:1b}}]} run function cpp:item_processer/type
# 物品输出
