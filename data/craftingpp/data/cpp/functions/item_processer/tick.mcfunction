...
# 配方
execute unless predicate cpp:redstone_power if block ~ ~ ~ barrel{Items:[{Slot:3b},{Slot:12b},{Slot:15b,tag:{cppClear:1b}},{Slot:16b,tag:{cppClear:1b}}]} run function cpp:item_processer/type
# 物品输出
execute unless data block ~ ~ ~ Items[{Slot:15b,tag:{cppClear:1b}}] run function cpp:item_processer/dist15
execute unless data block ~ ~ ~ Items[{Slot:16b,tag:{cppClear:1b}}] run function cpp:item_processer/dist16
