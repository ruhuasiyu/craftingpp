...
execute if score #t cppValue matches 12970805 if score #rand cppValue matches 1..5 run summon piglin ~ ~-2 ~ {PersistenceRequired:1b}
execute if score #t cppValue matches 12970805 if score #rand cppValue matches 6..9 run summon piglin ~ ~-2 ~ {PersistenceRequired:1b,IsImmuneToZombification:1b}
execute if score #t cppValue matches 12970805 if score #rand cppValue matches 10 run summon hoglin ~ ~-2 ~ {PersistenceRequired:1b}
...
execute if score #t cppValue matches 12973208 run summon horse ~ ~-2 ~ {PersistenceRequired:1b}
