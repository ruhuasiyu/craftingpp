...
function cpp:random
execute if score #rand cppValue matches 1..9 run summon minecraft:guardian ~ ~-2 ~ {PersistenceRequired:1b}
execute if score #rand cppValue matches 10 run summon minecraft:elder_guardian ~ ~-2 ~ {PersistenceRequired:1b}
