...
function cpp:random
execute if score #rand cppValue matches 1..5 run summon minecraft:slime ~ ~-2 ~ {Size:0,PersistenceRequired:1b}
execute if score #rand cppValue matches 6..8 run summon minecraft:slime ~ ~-2 ~ {Size:1,PersistenceRequired:1b}
execute if score #rand cppValue matches 9..10 run summon minecraft:slime ~ ~-2 ~ {Size:2,PersistenceRequired:1b}
