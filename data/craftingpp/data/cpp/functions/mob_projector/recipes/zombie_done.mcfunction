...
function cpp:random
execute if score #rand cppValue matches 1..11 run summon minecraft:zombie ~ ~-2 ~ {PersistenceRequired:1b}
execute if score #rand cppValue matches 12..13 run summon minecraft:zombie_villager ~ ~-2 ~ {PersistenceRequired:1b}
execute if score #rand cppValue matches 14..15 run summon minecraft:husk ~ ~-2 ~ {PersistenceRequired:1b}
execute if score #rand cppValue matches 16 run summon minecraft:drowned ~ ~-2 ~ {PersistenceRequired:1b}
