...
function cpp:random
execute if score #rand cppValue matches 1..9 run summon minecraft:llama ~ ~-2 ~ {PersistenceRequired:1b}
execute if score #rand cppValue matches 10 run summon minecraft:trader_llama ~ ~-2 ~ {PersistenceRequired:1b}
