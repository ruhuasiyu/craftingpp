...
function cpp:random
execute if score #rand cppValue matches 1..15 run summon minecraft:skeleton ~ ~-2 ~ {PersistenceRequired:1b}
execute if score #rand cppValue matches 16 run summon minecraft:stray ~ ~-2 ~ {PersistenceRequired:1b}
