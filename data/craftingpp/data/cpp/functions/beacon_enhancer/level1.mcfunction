...
execute as @s[scores={cppMobType=0,cppMobEff=1}] run effect give @e[type=#cpp:hostile,type=!armor_stand,distance=..20] slowness 11
execute as @s[scores={cppMobType=0,cppMobEff=2}] run effect give @e[type=#cpp:hostile,type=!armor_stand,distance=..20] weakness 11
execute as @s[scores={cppMobType=0,cppMobEff=3}] run effect give @e[type=#cpp:hostile,type=!armor_stand,distance=..20] glowing 11
execute as @s[scores={cppMobType=0,cppMobEff=4}] run effect give @e[type=#cpp:hostile,type=!armor_stand,distance=..20] poison 11
execute as @s[scores={cppMobType=0,cppMobEff=5}] run effect give @e[type=#cpp:hostile,type=!armor_stand,distance=..20] wither 11
