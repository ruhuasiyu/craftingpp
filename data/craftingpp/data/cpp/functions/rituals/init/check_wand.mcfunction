...
scoreboard players set @s[scores={cppWandLevel=0},nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:sealing_wand"}}]}] cppWandLevel 1
scoreboard players set @s[scores={cppWandLevel=0},nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:star_wand"}}]}] cppWandLevel 2
scoreboard players set @s[scores={cppWandLevel=0},nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:dream_wand"}}]}] cppWandLevel 3
scoreboard players set @s[scores={cppWandLevel=0},nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:wand_of_the_darkness"}}]}] cppWandLevel 16
