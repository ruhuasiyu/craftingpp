...
execute as @s[nbt={SelectedItem:{tag:{id:"cpp:golem_miner"}}}] at @s anchored eyes run function cpp:use_carrot_on_a_stick/golem/type
execute as @s[nbt={SelectedItem:{tag:{id:"cpp:golem_farmer"}}}] at @s anchored eyes run function cpp:use_carrot_on_a_stick/golem/type
execute as @s[nbt={SelectedItem:{tag:{id:"cpp:golem_fisher"}}}] at @s anchored eyes run function cpp:use_carrot_on_a_stick/golem/type
execute as @s[nbt={SelectedItem:{tag:{id:"cpp:golem_warrior"}}}] at @s anchored eyes run function cpp:use_carrot_on_a_stick/golem/type
execute as @s[nbt={SelectedItem:{tag:{id:"cpp:golem_herder"}}}] at @s anchored eyes run function cpp:use_carrot_on_a_stick/golem/type
