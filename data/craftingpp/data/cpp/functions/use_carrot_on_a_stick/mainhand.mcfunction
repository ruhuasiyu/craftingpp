...
execute as @s[nbt={SelectedItem:{tag:{id:"cpp:compressor"}}}] run function cpp:use_carrot_on_a_stick/tool/compressor
...
execute as @s[nbt={SelectedItem:{tag:{id:"cpp:golem_miner"}}}] anchored eyes run function cpp:use_carrot_on_a_stick/golem/type
execute as @s[nbt={SelectedItem:{tag:{id:"cpp:golem_farmer"}}}] anchored eyes run function cpp:use_carrot_on_a_stick/golem/type
execute as @s[nbt={SelectedItem:{tag:{id:"cpp:golem_fisher"}}}] anchored eyes run function cpp:use_carrot_on_a_stick/golem/type
execute as @s[nbt={SelectedItem:{tag:{id:"cpp:golem_warrior"}}}] anchored eyes run function cpp:use_carrot_on_a_stick/golem/type
execute as @s[nbt={SelectedItem:{tag:{id:"cpp:golem_herder"}}}] anchored eyes run function cpp:use_carrot_on_a_stick/golem/type
...
execute as @s[nbt={SelectedItem:{tag:{id:"cpp:sealing_wand"}}}] run function cpp:rituals/init/check_wand
execute as @s[nbt={SelectedItem:{tag:{id:"cpp:star_wand"}}}] run function cpp:rituals/init/check_wand
execute as @s[nbt={SelectedItem:{tag:{id:"cpp:dream_wand"}}}] run function cpp:rituals/init/check_wand
execute as @s[nbt={SelectedItem:{tag:{id:"cpp:wand_of_the_darkness"}}}] run function cpp:rituals/init/check_wand
