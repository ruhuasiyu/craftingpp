...
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:green_force_of_water"}}]}] at @s anchored eyes run function cpp:use_carrot_on_a_stick/elements/green
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:cyan_force_of_mountain"}}]}] at @s run function cpp:use_carrot_on_a_stick/elements/cyan
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:orange_force_of_dirt"}}]}] at @s anchored eyes run function cpp:use_carrot_on_a_stick/elements/orange
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:yellow_force_of_earth"}}]}] at @s run function cpp:use_carrot_on_a_stick/elements/yellow
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:red_force_of_fire"}}]}] at @s anchored eyes run function cpp:use_carrot_on_a_stick/elements/red
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:purple_force_of_life"}}]}] at @s run function cpp:use_carrot_on_a_stick/elements/purple
...
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:black_force_of_moon"}}]}] at @s run function cpp:use_carrot_on_a_stick/elements/black
...
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:compressor"}}]}] at @s run function cpp:use_carrot_on_a_stick/tool/compressor
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:coordinate_recorder",hasRecord:1b}}]},scores={cppSneakTime=1..}] at @s anchored eyes run function cpp:use_carrot_on_a_stick/tool/coordinate_recorder_pos
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{id:"cpp:coordinate_recorder"}}]}] unless entity @s[scores={cppSneakTime=1..}] at @s run function cpp:use_carrot_on_a_stick/tool/coordinate_recorder_off
