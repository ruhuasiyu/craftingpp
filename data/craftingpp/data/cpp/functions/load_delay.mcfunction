tellraw @a [{"translate":"info.cpp.load1"},{"translate":"info.cpp.load2","clickEvent":{"action":"open_url","value":"http://home.ustc.edu.cn/~zsxqq/craftingpp"}},{"translate":"info.cpp.load3"},"§r1.11, ",{"translate":"info.cpp.load4"}]
