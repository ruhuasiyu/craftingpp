...
execute as @s[predicate=cpp:mainhand/carrot_on_a_stick] run data modify storage cpp:temp tool set from entity @s SelectedItem
execute as @s[predicate=!cpp:mainhand/carrot_on_a_stick] run data modify storage cpp:temp tool set from entity @s Inventory[{Slot:-106b}]
