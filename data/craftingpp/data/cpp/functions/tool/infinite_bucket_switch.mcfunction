...
execute if score #t cppValue matches 0 run data modify storage cpp:infinite_bucket Item.tag.cppLiquid.type set value 1
execute if score #t cppValue matches 0 run title @s actionbar {"translate":"info.cpp.infinite_bucket.lava"}
execute if score #t cppValue matches 1 run data modify storage cpp:infinite_bucket Item.tag.cppLiquid.type set value 0
execute if score #t cppValue matches 1 run title @s actionbar {"translate":"info.cpp.infinite_bucket.water"}
