...
execute positioned ~ ~1 ~ if block ~ ~ ~ minecraft:cauldron if entity @e[type=item,distance=..1,predicate=cpp:item/cauldron_on] run function cpp:block_breaker/cauldron
