...
execute if score @s cppValue matches 2 run data modify block ~ 255 ~1 Items[{id:"minecraft:golden_carrot"}] set from block ~ 255 ~ Items[{id:"minecraft:golden_carrot"}]
execute if score @s cppValue matches 3 run data modify block ~ 255 ~1 Items[{id:"minecraft:dandelion"}] set from block ~ 255 ~ Items[{id:"minecraft:dandelion"}]
...
data merge entity @e[type=minecraft:rabbit,distance=..1,nbt={Age:0,InLove:0},limit=1] {InLove:600}
