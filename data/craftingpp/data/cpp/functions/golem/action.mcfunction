...
execute as @s[scores={cppGolemFace=0}] at @s run tp @s ~0.5 ~0 ~0 270 0
execute as @s[scores={cppGolemFace=1}] at @s run tp @s ~0 ~0 ~0.5 0 0
execute as @s[scores={cppGolemFace=2}] at @s run tp @s ~-0.5 ~0 ~0 90 0
execute as @s[scores={cppGolemFace=3}] at @s run tp @s ~0 ~0 ~-0.5 180 0
execute as @s[scores={cppGolemFace=4}] at @s run tp @s ~0 ~0.5 ~0 0 90
execute as @s[scores={cppGolemFace=5}] at @s run tp @s ~0 ~-0.5 ~0 0 -90
