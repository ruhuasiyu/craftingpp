...
execute if block ~ ~ ~ #cpp:industrious_hand_grow if entity @e[type=item,nbt={Item:{id:"minecraft:shears"}},distance=..2] run function cpp:golem/hand/industrious_hand_grow
