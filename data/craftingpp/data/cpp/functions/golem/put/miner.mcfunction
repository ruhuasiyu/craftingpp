...
data modify entity @e[type=armor_stand,tag=cpp_temp,sort=nearest,limit=1,distance=..2] HandItems[0].tag.Enchantments set from storage cpp:golem put.Enchantments
