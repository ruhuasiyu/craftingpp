...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:acacia_sapling"}}] run data modify entity @e[tag=cpp_plants,tag=cpp_temp,distance=..0.1,limit=1] ArmorItems[3] set from entity @s SelectedItem
execute unless entity @s[nbt={SelectedItem:{id:"minecraft:acacia_sapling"}}] run data modify entity @e[tag=cpp_plants,tag=cpp_temp,distance=..0.1,limit=1] ArmorItems[3] set from entity @s Inventory[{Slot:-106b}]
