...
# 羊毛
execute as @s[tag=cpp_wool_leaves] unless entity @e[type=item,nbt={Item:{id:"minecraft:acacia_leaves"}},distance=..2] unless entity @e[type=item,nbt={Item:{id:"minecraft:acacia_sapling"}},distance=..2] run loot spawn ~ ~ ~ loot cpp:misc/wool_leaves
kill @s
