...
tag @e[type=item,sort=nearest,nbt={Age:0s,Item:{id:"minecraft:pumpkin_seeds",Count:1b}},limit=1,distance=..2] add cpp_block_drop
tag @e[type=item,sort=nearest,nbt={Age:1s,Item:{id:"minecraft:pumpkin_seeds",Count:1b}},limit=1,distance=..2] add cpp_block_drop
execute unless entity @e[type=item,distance=..2,tag=cpp_block_drop] run summon item ~ ~ ~ {Item:{id:"minecraft:pumpkin_seeds",Count:1b},Tags:["cpp_block_drop"]}
