...
execute if block ~ ~ ~ oak_sign run function cpp:block/put/oak_sign_pre
...
execute if block ~ ~ ~ chest as @e[type=armor_stand,tag=cpp_block,distance=..0.5,limit=1] run function cpp:block/put/chest
execute if block ~ ~ ~ gold_block as @e[type=armor_stand,tag=cpp_block,distance=..0.5,limit=1] run function cpp:block/put/gold_block
execute if block ~ ~ ~ oak_sign as @e[type=armor_stand,tag=cpp_block,distance=..0.5,limit=1] run function cpp:block/put/oak_sign
