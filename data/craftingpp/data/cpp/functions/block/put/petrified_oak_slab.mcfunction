execute unless data storage cpp:temp block.tag.id run data modify storage cpp:temp block.tag.cpp_tag set value ['machine','need_fire','barrel']
data modify storage cpp:temp block.Count set value 1b

setblock ~ ~ ~ barrel{CustomName:'{"translate":"block.minecraft.petrified_oak_slab"}'}
execute if data storage cpp:temp block.tag{cpp_tag:['chest']} run setblock ~ ~ ~ chest
execute if data storage cpp:temp block.tag{cpp_tag:['gold_block']} run setblock ~ ~ ~ gold_block
execute if data storage cpp:temp block.tag{cpp_tag:['leaves']} run setblock ~ ~ ~ acacia_leaves[persistent=true]
execute if data storage cpp:temp block.tag{cpp_tag:['plants']} run setblock ~ ~ ~ acacia_sapling
data modify block ~ ~ ~ CustomName set from storage cpp:temp block.tag.display.Name
