...
# 修改帽子
scoreboard players set #random_min cppRandom 12970051
scoreboard players set #random_max cppRandom 12970058
function cpp:random
execute store result entity @s ArmorItems[3].tag.CustomModelData int 1 run scoreboard players get @s cppRandom
