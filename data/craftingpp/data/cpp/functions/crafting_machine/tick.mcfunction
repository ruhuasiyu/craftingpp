...
execute as @s[tag=!cpp_redstone_powered] if data block ~ ~ ~ Items[{Slot:16b,tag:{cppMachineBg:1b}}] run function cpp:crafting_machine/check
# 物品输出
execute unless data block ~ ~ ~ Items[{Slot:16b,tag:{cppMachineBg:1b}}] run function cpp:crafting_machine/dist
