execute store result score #t2 cppValue run data get block ~ ~ ~ Items[{Slot:1b}].tag.display.color 0.00390625
scoreboard players operation #t2 cppValue %= #256 cppValue
...
scoreboard players operation #t1 cppValue *= #256 cppValue
