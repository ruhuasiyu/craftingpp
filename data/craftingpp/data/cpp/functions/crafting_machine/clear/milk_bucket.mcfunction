...
execute store result score #t1 cppValue run data remove storage cpp:cm_replace Items[{id:"minecraft:milk_bucket",Count:1b}]
execute store result score #t2 cppValue run data remove storage cpp:cm_replace Items[{id:"minecraft:milk_bucket"}]
...
execute as @s[tag=!cpp_dist_success] if data block ~ ~ ~ Items[{id:"minecraft:milk_bucket",Count:1b}] run data modify block ~ ~ ~ Items[{id:"minecraft:milk_bucket",Count:1b}] merge value {id:"minecraft:bucket",Count:2b}
