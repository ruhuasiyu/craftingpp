...
execute store result score #t1 cppValue run data remove storage cpp:temp Items[{id:"minecraft:lava_bucket",Count:1b}]
execute store result score #t2 cppValue run data remove storage cpp:temp Items[{id:"minecraft:lava_bucket"}]
