...
execute if block ~ ~ ~ barrel{Items:[{tag:{dict:"salt"}},{id:"minecraft:cooked_chicken"},{id:"minecraft:wheat"}]} run loot replace block ~ ~ ~ container.16 loot cpp:meat_floss_bread
...
execute if block ~ ~ ~ barrel{Items:[{tag:{id:"cpp:tomato"}},{tag:{dict:"salt"}},{id:"minecraft:sugar"}]} run loot replace block ~ ~ ~ container.16 loot cpp:ketchup
